      ...
      <div className="max-w-md w-full mx-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to your PastelShop account</p>
          </div>
            ...
            <div className="mt-6 space-y-3">
              ...
              >
                <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24">
                  <path
                    fill="#000"
                    d="M12 0C5.372 0 0 5.372 0 12c0 6.628 5.372 12 12 12 6.628 0 12-5.372 12-12C24 5.372 18.628 0 12 0zm5.568 7.083c-.77.173-1.588.353-2.455.568 1.02-.613 1.801-1.586 2.165-2.747-.956.569-2.015.984-3.145 1.207-.901-.96-2.186-1.561-3.608-1.561-2.73 0-4.942 2.212-4.942 4.942 0 .387.044.764.128 1.126-4.108-.206-7.75-2.175-10.188-5.168-.426.732-.67 1.586-.67 2.495 0 1.713.871 3.225 2.195 4.109-.809-.026-1.57-.248-2.237-.617v.062c0 2.394 1.704 4.39 3.964 4.844-.415.113-.852.175-1.303.175-.318 0-.628-.031-.93-.088.629 1.96 2.447 3.39 4.604 3.429-1.686 1.32-3.809 2.107-6.115 2.107-.398 0-.79-.023-1.175-.068 2.179 1.397 4.768 2.212 7.548 2.212 9.057 0 14.01-7.503 14.01-14.01 0-.213-.005-.425-.014-.636.962-.695 1.8-1.562 2.46-2.549z"
                  />
                </svg>
                Sign in with Apple
              </motion.button>
